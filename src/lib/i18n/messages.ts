...
const ca = {
	...
	habitatPoints: 'Punts d’hàbitats',
	...
	updateReady: 'Hi ha una versió nova del mapa',
	updateTake: 'Actualitzar',
	...
	habitatPointsHint:
		'Llocs concrets on la cartografia va trobar gorgònies o algues invasores. Són punts, no superfícies: diuen on n’hi ha, no fins on arriba.',
	habitatPointsOff: 'Els punts d’hàbitats estan apagats. Activa’ls per veure’ls al mapa.',
	habitatPointsShow: 'Mostrar els punts d’hàbitats',
	...
	lightSignal: 'Senyal',
	waterLevel: 'Nivell',
	habitatPoint: 'Registre d’hàbitat',
	pointSpecies: 'Espècies característiques',
	pointDepth: 'Fondària del registre',
	...
	updateSection: 'Versió',
	updateCheck: 'Buscar una actualització ara',
	updateChecking: 'Preguntant…',
	updateCheckHint: 'Pregunta al servidor si hi ha un mapa més nou que el que tens obert.',
	updateCurrent: 'Ja tens la versió més nova.',
	updateComing: 'N’hi ha una de nova baixant-se. El mapa t’avisarà quan estigui a punt.',
	updateFailed: 'No s’ha pogut preguntar al servidor. Mira la connexió.',
	updateUnsupported: 'Aquest navegador no guarda cap còpia per a quan no hi ha connexió.',
	storageSection: 'Espai al navegador',
	storageUsed: 'Ocupat',
	storageLimit: 'Límit',
	storageKept: 'El navegador s’ha compromès a guardar-ho.',
	storageAtRisk: 'El navegador ho pot esborrar si al telèfon li falta espai.',
	storageUnknown: 'Aquest navegador no diu quant espai ocupa.',
	storageClearMap: 'Esborrar les dades del mapa',
	storageClearMapHint:
		'Treu les tessel·les del fons i els fitxers que el mapa ha anat agafant mentre navegaves. Les zones desades es queden. La resta es torna a baixar quan la necessites.',
	storageClearMapWarn: 'Necessites connexió per tornar-ho a baixar.',
	storageClearMapSure: 'Esborrar-les de debò',
	storageClearAll: 'Esborrar-ho tot i començar de nou',
	storageClearAllHint: 'Ho treu tot i torna a baixar el mapa de zero.',
	storageClearAllWarn:
		'Les zones desades també se’n van, i només es poden tornar a baixar amb connexió. No ho facis en una barca.',
	storageClearAllSure: 'Esborrar-ho tot de debò',
	storageClearing: 'Esborrant…',
	storageCleared:
		'Dades del mapa esborrades. Les zones desades es queden. El navegador et torna l’espai quan li va bé.',
	storageClearFailed: 'El navegador no ho ha deixat anar.',
...
const es: Catalogue = {
	...
	habitatPoints: 'Puntos de hábitats',
	...
	updateReady: 'Hay una versión nueva del mapa',
	updateTake: 'Actualizar',
	...
	habitatPointsHint:
		'Lugares concretos donde la cartografía encontró gorgonias o algas invasoras. Son puntos, no superficies: dicen dónde hay, no hasta dónde llega.',
	habitatPointsOff: 'Los puntos de hábitats están apagados. Actívalos para verlos en el mapa.',
	habitatPointsShow: 'Mostrar los puntos de hábitats',
	...
	baseMapRecommended: 'Recomendado',
	...
	lightSignal: 'Señal',
	waterLevel: 'Nivel',
	habitatPoint: 'Registro de hábitat',
	pointSpecies: 'Especies características',
	pointDepth: 'Profundidad del registro',
	...
	updateSection: 'Versión',
	updateCheck: 'Buscar una actualización ahora',
	updateChecking: 'Preguntando…',
	updateCheckHint: 'Pregunta al servidor si hay un mapa más nuevo que el que tienes abierto.',
	updateCurrent: 'Ya tienes la versión más nueva.',
	updateComing: 'Hay una nueva descargándose. El mapa te avisará cuando esté lista.',
	updateFailed: 'No se ha podido preguntar al servidor. Mira la conexión.',
	updateUnsupported: 'Este navegador no guarda ninguna copia para cuando no hay conexión.',
	storageSection: 'Espacio en el navegador',
	storageUsed: 'Ocupado',
	storageLimit: 'Límite',
	storageKept: 'El navegador se ha comprometido a guardarlo.',
	storageAtRisk: 'El navegador puede borrarlo si al teléfono le falta espacio.',
	storageUnknown: 'Este navegador no dice cuánto espacio ocupa.',
	storageClearMap: 'Borrar los datos del mapa',
	storageClearMapHint:
		'Quita las teselas del fondo y los archivos que el mapa ha ido cogiendo mientras navegabas. Las zonas guardadas se quedan. El resto se vuelve a descargar cuando lo necesitas.',
	storageClearMapWarn: 'Necesitas conexión para volver a descargarlo.',
	storageClearMapSure: 'Borrarlos de verdad',
	storageClearAll: 'Borrarlo todo y empezar de nuevo',
	storageClearAllHint: 'Lo quita todo y vuelve a descargar el mapa desde cero.',
	storageClearAllWarn:
		'Las zonas guardadas también se van, y solo se pueden volver a descargar con conexión. No lo hagas en una barca.',
	storageClearAllSure: 'Borrarlo todo de verdad',
	storageClearing: 'Borrando…',
	storageCleared:
		'Datos del mapa borrados. Las zonas guardadas se quedan. El navegador te devuelve el espacio cuando le va bien.',
	storageClearFailed: 'El navegador no lo ha soltado.',
...
const en: Catalogue = {
	...
	updateReady: 'A new version of the map is ready',
	updateTake: 'Update',
	...
	habitatPointsHint:
		'Places where the survey found gorgonians or invasive algae. Points, not areas: they say where it is, not how far it reaches.',
	habitatPointsOff: 'The habitat points are switched off. Turn them on to see them on the map.',
	habitatPointsShow: 'Show the habitat points',
	...
	baseMapRecommended: 'Recommended',
	...
	lightSignal: 'Signal',
	waterLevel: 'Level',
	habitatPoint: 'Habitat record',
	pointSpecies: 'Characteristic species',
	pointDepth: 'Depth at the record',
	...
	updateCheck: 'Check for an update now',
	updateChecking: 'Asking…',
	updateCheckHint: 'Asks the server whether there is a newer map than the one you have open.',
	updateCurrent: 'You already have the newest version.',
	updateComing: 'A new one is downloading. The map will tell you when it is ready.',
	updateFailed: 'Could not ask the server. Check the connection.',
	updateUnsupported: 'This browser keeps no copy for when there is no connection.',
	storageSection: 'Space in this browser',
	storageUsed: 'Used',
	storageLimit: 'Limit',
	storageKept: 'The browser has promised to keep it.',
	storageAtRisk: 'The browser may clear it if the phone runs short of space.',
	storageUnknown: 'This browser does not say how much space it is using.',
	storageClearMap: 'Clear the map data',
	storageClearMapHint:
		'Drops the seabed tiles and the files the map picked up while you browsed. The saved areas stay. The rest is downloaded again when you need it.',
	storageClearMapWarn: 'You need a connection to load it again.',
	storageClearMapSure: 'Yes, clear them',
	storageClearAll: 'Clear everything and start again',
	storageClearAllHint: 'Takes it all and downloads the map again from scratch.',
	storageClearAllWarn:
		'The saved areas go too, and they can only be downloaded again with a connection. Do not do this on a boat.',
	storageClearAllSure: 'Yes, clear everything',
	storageClearing: 'Clearing…',
	storageCleared:
		'Map data cleared. The saved areas stayed. The browser gives the space back in its own time.',
	storageClearFailed: 'The browser would not let go of it.',
